...
')
     ...
     */ 
        ...
        {
                        /** @var \Ensi\LaravelEnsiFilesystem\EnsiFilesystemManager $instance */
         ...
         * @param string $name
         * @param mixed $disk
         * @return \Ensi\LaravelEnsiFilesystem\EnsiFilesystemManager 
         * @static 
         */ 
        public static function set($name, $disk)
        {            //Method inherited from \Illuminate\Filesystem\FilesystemManager         
...
namespace  { 
            ...
            class EnsiStorage extends \Ensi\LaravelEnsiFilesystem\EnsiStorageFacade {}
