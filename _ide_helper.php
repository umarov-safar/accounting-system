...
')
     ...
     */
         ...
         * @static
         */
            public static function protected($service = null)
            {
                /** @var \App\Infrastructure\EnsiFilesystem\EnsiFilesystemManager $instance */
                return $instance->protected($service);
            }
         ...
         * @static
         */
            public static function public($service = null)
            {
                /** @var \App\Infrastructure\EnsiFilesystem\EnsiFilesystemManager $instance */
                return $instance->public($service);
            }
         ...
         */
            public static function drive($name = null)
            {            //Method inherited from \Illuminate\Filesystem\FilesystemManager
                /** @var \App\Infrastructure\EnsiFilesystem\EnsiFilesystemManager $instance */
                return $instance->drive($name);
            }
         ...
         * @param string $name
         * @param mixed $disk
         * @return \App\Infrastructure\EnsiFilesystem\EnsiFilesystemManager
         * @static
         */
            public static function set($name, $disk)
            {            //Method inherited from \Illuminate\Filesystem\FilesystemManager
...
namespace  {
            ...
            class EnsiStorage extends \App\Infrastructure\EnsiFilesystem\EnsiStorageFacade
            {
            }
